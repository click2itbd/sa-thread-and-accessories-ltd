                  ...
                  >
                    ...
                    {contactLinks.length > 0 && (
                      <div className="w-full py-3 mt-auto flex items-center justify-center gap-3 bg-gray-50 border-t border-gray-100">
                        {member.facebookUrl &&
                          contactLinks.includes(member.facebookUrl) && (
                            <a
                        ...
                        {member.linkedinUrl &&
                          contactLinks.includes(member.linkedinUrl) && (
                            <a
                        ...
                        {member.whatsappNumber &&
                          contactLinks.includes(member.whatsappNumber) && (
                            <a
                        ...
                        {member.email &&
                          contactLinks.includes(member.email) && (
                            <a
                        ...
                        {member.phone &&
                          contactLinks.includes(member.phone) && (
                            <a
