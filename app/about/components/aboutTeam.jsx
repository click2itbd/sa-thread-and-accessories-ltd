...
import { Users, Building2, Package, BadgeCheck, Mail, Phone } from "lucide-react";
...
export default function AboutTeam({ members: propMembers }) {
  ...
  const leadershipCount = teamMembers.filter(
    (member) => member.dept === "Management",
  ).length;
  const departmentCount = new Set(
    teamMembers.map((member) => member.dept).filter(Boolean),
  ).size;
  const specialistCount = teamMembers.length - leadershipCount;
  const teamStats = [
    { icon: Users, stat: `${teamMembers.length}`, label: "Dedicated\nTeam Members" },
    { icon: BadgeCheck, stat: `${leadershipCount}`, label: "Leadership\nTeam Members" },
    { icon: Building2, stat: `${departmentCount}`, label: "Working\nDepartments" },
    { icon: Package, stat: `${specialistCount}`, label: "Marketing & Production\nSpecialists" },
  ];
              ...
              return (
                ...
                >
                  ...
                  {contactLinks.length > 0 && (
                    ...
                    {member.facebookUrl && contactLinks.includes(member.facebookUrl) && (
                      <a 
                    ...
                    {member.linkedinUrl && contactLinks.includes(member.linkedinUrl) && (
                      <a 
                    ...
                    {member.whatsappNumber && contactLinks.includes(member.whatsappNumber) && (
                      <a 
                    ...
                    {member.email && contactLinks.includes(member.email) && (
                      <a
                    ...
                    {member.phone && contactLinks.includes(member.phone) && (
                      <a
